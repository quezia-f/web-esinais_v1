...
export default function App() {
  ...
  return (
    <div className={`${isDarkMode ? 'dark bg-slate-950' : 'bg-[#F8F9FA]'} h-screen overflow-hidden font-sans flex flex-col text-slate-800 dark:text-slate-100 transition-colors duration-300`}>
      ...
      {currentView === 'translator' && (
        <div className="shrink-0 bg-[#1A1A24] text-blue-100 py-3 text-center text-sm font-medium shadow-sm z-10 transition-colors duration-300">
          ...
          <section className="bg-white dark:bg-[#13131B] rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col overflow-hidden h-full transition-colors duration-300">
            <div className="bg-white dark:bg-[#13131B] border-b border-slate-100 dark:border-slate-700 p-4 md:px-6 md:py-5 flex justify-between items-center shrink-0 transition-colors duration-300">
              ...
              <div className="flex gap-2">
                <button className="p-2 text-slate-400 dark:text-slate-500 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-slate-700 rounded-lg transition-colors" title="Colar">
          ...
          <section className="relative bg-white dark:bg-[#13131B] rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col overflow-hidden h-full transition-colors duration-300">
            ...
            <div className="bg-white dark:bg-[#13131B] border-b border-slate-100 dark:border-slate-700 p-4 md:px-6 md:py-5 flex justify-between items-center shrink-0 transition-colors duration-300">
              ...
              <div className="flex gap-2">
                ...
                <button className="p-2 text-slate-400 dark:text-slate-500 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-slate-700 rounded-lg transition-colors" title="Expandir">
      ...
      {selectedImage && (
        <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none p-4">
          <Draggable handle=".drag-handle">
            <div className="w-full max-w-lg bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col pointer-events-auto">
      ...
      {selectedDetailItem && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div className="bg-white dark:bg-slate-900 w-full max-w-2xl max-h-[calc(100vh-2rem)] flex flex-col rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200 border border-slate-200 dark:border-slate-700">
                            ...
                            <div className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-600 dark:text-slate-400 mt-1 leading-relaxed">
                                        {selectedDetailItem.definition || "Definição n��o disponível."}
                                    </p>
                                </div>
                            </div>
                             <div className="flex gap-3">
                ...
                {/* Footer */}
                <div className="shrink-0 p-6 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-800 flex justify-end">
