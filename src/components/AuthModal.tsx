...
export function AuthModal({ isOpen, onClose, isDarkMode, onLogin }: AuthModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Container */}
      <div className="relative w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl shadow-2xl overflow-hidden transform transition-all duration-300 animate-in fade-in zoom-in-95 ring-1 ring-slate-900/5 dark:ring-slate-700/50 border border-transparent dark:border-slate-800">
        
        {/* Decorative Header Background */}
        <div className="absolute top-0 left-0 right-0 h-32 bg-slate-50 dark:bg-slate-950">
            ...
            <>
              <div className="w-full mb-6">
                <button className="flex items-center justify-center gap-2 py-2.5 px-4 bg-slate-50 dark:bg-[#13131B] hover:bg-slate-100 dark:hover:bg-[#111827] border border-slate-200 dark:border-slate-800 rounded-xl transition-all duration-200 group w-full">
                  ...
                  <span className="text-sm font-medium text-slate-600 dark:text-slate-300">Entre com o Google</span>
                </button>
              </div>
              ...
              <div className="relative w-full mb-6 flex items-center justify-center">
                ...
                <span className="relative bg-white dark:bg-slate-900 px-4 text-xs font-medium text-slate-400 uppercase tracking-wider">
                  Ou continue com
                </span>
              </div>
            </>
